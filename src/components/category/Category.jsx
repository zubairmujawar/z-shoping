        ...
        <div className="flex overflow-x-scroll lg:justify-center  hide-scroll-bar">
          ...
          <div className="flex md:w-[100vw]">
            ...
            {category.map((item, index) => {
              return (
                <div key={index} className="px-3 lg:px-10 shadow-lg">
                  {/* Image  */}
                  <div className=" w-16 h-16 lg:w-24 lg:h-24 max-w-xs rounded-full  bg-orange-400 transition-all hover:bg-orange-300 cursor-pointer mb-1 ">
